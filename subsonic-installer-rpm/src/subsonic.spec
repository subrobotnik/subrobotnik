...
%attr(755,root,root) /var/subrobotnik/transcode/ffmpeg
%attr(755,root,root) /var/subrobotnik/transcode/lame
...
# Backup database.
if [ -e /var/subrobotnik/db ]; then
  rm -rf /var/subrobotnik/db.backup
  cp -R /var/subrobotnik/db /var/subrobotnik/db.backup
fi
...
chmod 750 /var/subrobotnik

# Clear jetty cache.
rm -rf /var/subrobotnik/jetty
